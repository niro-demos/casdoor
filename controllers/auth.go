...
func (c *ApiController) HandleLoggedIn(application *object.Application, user *object.User, form *form.AuthForm) (resp *Response) {
	...
	if form.Type == ResponseTypeLogin {
		...
		if service != "" {
			...
			// showing the login page (via object.CheckCasLogin). Without it,
			// any logged-in user could have a ticket minted for an arbitrary,
			// unregistered service URL and have their full profile handed to
			// whoever controls it.
